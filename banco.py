...
def efetuar_saque() -> None:
    if len(contas) > 0:
        ...
        if conta:
            ...
            print(f'Não foi possível encontrar a conta com o número {numero}')
    else:
    ...
    if len(contas) > 0:
        ...
        if conta_o:
            ...
            if conta_d:
                ...
                print(f'Não foi possível encontrar a conta com o número {numero_d}')
        else:
            print(f'Não foi possível encontrar a conta com o número {numero_o}')
    else:
        print('Ainda não existem contas cadastradas.')
